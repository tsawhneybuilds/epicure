...
export function OnboardingScreen({ onComplete, isReturningUser = false }: OnboardingScreenProps) {
  ...
  // Skip directly to personalization if returning user
  useEffect(() => {
    if (isReturningUser && step === 'apple-id') {
      setStep('personalization');
    }
  }, [isReturningUser, step]);
